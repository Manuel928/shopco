...
const Partners = () => {
  return (
    <div className='flex flex-wrap max-w-[1440px] items-center justify-center lg:justify-between gap-[34px] py-[39px] lg:py-[45px] lg:gap-[106px] bg-black px-[16px] lg:px-[100px]'>
